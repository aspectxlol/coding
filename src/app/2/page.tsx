...
export default function StepTwoPage() {
  ...
  return (
    <CodingAdventureFlow
      ...
      description="Sebuah kartu TCG berkilau muncul dari kabut neon. Esther Rouli, mentor coding kamu, siap bantu di tantangan berikutnya."
      nextRoute="/3"
      prevRoute="/1"
