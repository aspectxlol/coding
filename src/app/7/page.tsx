    ...
    >
      <div className="rounded-none border border-cyan-400/40 bg-slate-900/70 p-4">
        <div className="rounded-none border border-amber-400/40 bg-gradient-to-br from-amber-500/10 to-cyan-500/10 p-6 text-center">
          ...
          <h2 className="mt-4 text-3xl font-black uppercase tracking-[0.2em] text-white">Sertifikat selesai</h2>
          ...
          <p className="mt-6 text-sm leading-7 text-slate-300">
            telah menyelesaikan perjalanan Petualangan Coding, bantu kamu lihat konsep coding dari dekat, dan buka percikan pertama buat jadi creator.
          </p>
